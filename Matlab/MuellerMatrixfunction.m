function [P] = MuellerMatrixfunction(Ordnerpfadreadout,answer1,answer)
tic
%Variablen:
%%
color = [0 0 1
...
%%
            ...
            directory_name = Ordnerpfadreadout;
...
% Für Bereich A
roundeduperleftcorner = [886 1214];  % 1. Schritt: MM-Ausschnitt die Koordinaten finden
roundetlowerrightcorner = [1116 1415];
...
%Element M11 auf den Wert 1 Normieren
normM11 = M11/max(max(M11)); 
%Bild der Normierten Matrix (alle Bilder mit M11 normiert außer M11 selbst
fig = gcf;
imagesc ([nM11 nM12 nM13 nM14; nM21 nM22 nM23 nM24; nM31 nM32 nM33 nM34; nM41 nM42 nM43 nM44],[-1 1]);
colormap(color);
colorbar;
